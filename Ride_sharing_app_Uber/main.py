...
class RideSharingDemo:
    ...
    driver2 = Driver(2, "Bob Williams", "7890123456", "XYZ789", Location(37.7860, -122.4070), DriverStatus.AVAILABLE)        ride_service.add_driver(driver1)
